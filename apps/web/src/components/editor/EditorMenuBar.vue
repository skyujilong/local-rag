    ...
    <div class="menu-group">
      <n-tooltip placement="bottom">
        <template #trigger>
          <n-button
            text
            :type="isActive.textAlign({ align: 'left' }) ? 'primary' : undefined"
      ...
      <n-tooltip placement="bottom">
        <template #trigger>
          <n-button
            text
            :type="isActive.textAlign({ align: 'center' }) ? 'primary' : undefined"
      ...
      <n-tooltip placement="bottom">
        <template #trigger>
          <n-button
            text
            :type="isActive.textAlign({ align: 'right' }) ? 'primary' : undefined"
...
const isActive = computed(() => ({
  ...
  textAlign: (align: any) => props.editor?.isActive({ textAlign: align }) ?? false,
}));
